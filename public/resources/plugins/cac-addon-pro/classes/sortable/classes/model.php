	...
	function add_reset_button() {
		...
		<script type="text/javascript">
			jQuery(document).ready(function() {
				...
				jQuery('.tablenav.top .actions:last').append('<a href="javascript:;" id="cpac-reset-sorting" class="cpac-edit add-new-h2"><?php _e( 'Reset sorting', CAC_SC_TEXTDOMAIN ); ?> <?php echo $sortby; ?></a>');
